            ...
            <div class="leftside-navigation">
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="{{URL::to('/shipping')}}">Vận chyển</a></li>
                            <li><a href="{{URL::to('/order-details')}}">Chi tiết đặt hàng</a></li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a href="{{URL::to('')}}">Thống kê đơn hàng</a></li>
                            <li><a href="{{URL::to('')}}">Thống kê số lượng sản phẩm</a></li>
                        </ul>
                    </li>
                    <li class="sub-menu">
                        <a href="javascript:;">
